...
Plus en détail, le coeur au milieu, à gauche l'antenne Lollipop et à droite la caméra. Plus de détail dans les rubriques sur les choix de design. Ce PCB à fonctionné du premier coup. Voici un petit exemple de ce dont il est capable (entre autres : réglage de a qualité vidéo, compression, luminosité, saturation, contraste, filtre, enregistrement sur la SD Card) : 
